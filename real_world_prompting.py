...
# Let's take a look at how to write Real World Prompts
# Example Customer Reviews Prompt Template
...
# 2 Prompt Template suggestion from Anthropic
instructions_1 = """
...
instructions_2 = """
2. Analyse the review using the following steps.
...
- Extract and quote key phrases that suggest complaintsor issues. 
...
# 4 Example Reviews and output needed from the Model
instructions_4 = """
4. Here are some examples to guide your analysis:
<examples>
Example 1:
<customer_review>
I recently purchased the Acme SmartHome Hub and I am absolutely thrilled with it!
Setting it up was a breeze thanks to the intuitive app, and it seamlessly integrated with all my
other smart devices. The voice control feature is incredibly responsive, and I love being able to
control my home with simple commands. The design is sleek and modern, fitting perfectly in my living
room. Overall, the Acme SmartHome Hub has exceeded my expectations and I highly recommend it
to anyone looking to upgrade their home automation system.
</customer_review>
<review_breakdown>
a) Key Phrase Extraction:
- Positive Sentiment: "absolutely thrilled", "a breeze", "seamlessly integrated", "incredibly responsive",
  "love being able to control my home", "sleek and modern", "exceeded my expectations", "highly recommend"
- Complaints: None found
b) Sentiment Analysis:
- Arguments for Positive: The review contains numerous positive phrases indicating high satisfaction
  with the product's setup, integration, voice control, design, and overall experience.
- Arguments for Negative: None found
- Arguments for Neutral: None found
- Overall Sentiment: Positive
- Explanation: The review is overwhelmingly positive, with no negative or neutral comments.
c) Complaint Extraction:
- Complaints Found: 0
</review_breakdown>
<json>
{
  ...
  "sentiment_analysis": "The review is overwhelmingly positive, with numerous phrases indicating high satisfaction and no negative or neutral comments.",
  "complaints": []
}
</json>
"""
